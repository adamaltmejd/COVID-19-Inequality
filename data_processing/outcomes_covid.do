...
odbc load, exec("select lopnr as id, INDATUMA FROM SoS_R_PAR_SV_KLEV4 WHERE hdia IN ('U071', 'U072')")dsn("P1105") clear
...
odbc load, exec("select lopnr as id, DODSDAT from SoS_R_DORS_KLEV4 WHERE ULORSAK IN ('U071', 'U072')")dsn("P1105") clear
